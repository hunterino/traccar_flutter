...
abstract class PositionProvider(
    ...
    protected var deviceId = preferences.getString(TraccarController.KEY_DEVICE, "undefined")!!
    protected var interval = preferences.getString(TraccarController.KEY_INTERVAL, "600")!!.toLong()
    protected var distance: Double = preferences.getString(TraccarController.KEY_DISTANCE, "0")!!.toInt().toDouble()
    protected var angle: Double = preferences.getString(TraccarController.KEY_ANGLE, "0")!!.toInt().toDouble()
